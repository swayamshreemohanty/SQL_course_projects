...
-- )
-- VALUES 
--     ('Swayamshree', 'Apple Watch', 1 , false),
--     ('Sanghamitra', 'Samsung TV', 2, false),
--     ('Cheetah', 'Petrol', 10, true)
...
-- )
-- VALUES 
--     ('2021-01-01', 'Swayamshree', 'Airpods', 1 , false),
--     ('2024-01-02', 'Sanghamitra', 'Laptop', 2, false),
--     ('2021-12-31', 'Cheetah', 'Diesel', 100, true)
